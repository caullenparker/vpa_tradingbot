...
from components.theme import apply_theme, initialize_theme, theme_selector
...
def require_login() -> bool:
    ...
    top_left, top_center, top_right = st.columns([1, 0.55, 1])
    with top_center:
        theme_selector("login_theme_selector")
